...
describe('fragmentize', () => {
  ...
  it('Nothing for empty input', () => {
    expect(fragmentize('pattern', '')).toBe(null)
  })

  it('Nothing for longer pattern', () => {
    expect(fragmentize('pattern pattern', 'pattern')).toBe(null)
  })

  it('Nothing when partial matching', () => {
    expect(fragmentize('pattern', 'pat one more')).toBe(null)
  })
