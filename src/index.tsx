...
import Provider, { Dispatch, UrlRequest } from 'Provider'
...
type Msg = utils.Msg<[Model], [Model, Cmd<Msg>]>

const RequestUrl = cons(
...
const View: FC<{ model: Model; dispatch: Dispatch<Msg> }> = React.memo(
  ({ model, dispatch }) => {
    return model.screen.cata({
      DashboardScreen: dashboard => (
...
const subscriptions = (): Sub<Msg> => Sub.none
